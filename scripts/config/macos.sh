...
# Save screenshots to a temp folder that will delete them on the next restart
...
# Disable fade-in effect when opening launchpad
defaults write com.apple.dock springboard-show-duration -float 0

# Disable fade-out effect when opening launchpad
defaults write com.apple.dock springboard-hide-duration -float 0

# Disable animation when switching between launchpad pages
